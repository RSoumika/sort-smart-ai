...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SortSmart — Know where it goes" },
      {
        name: "description",
        content:
          "An AI-powered waste assistant that helps you identify, sort and dispose of everyday waste responsibly.",
      },
      { name: "author", content: "SortSmart" },
      { property: "og:title", content: "SortSmart — Know where it goes" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/sortsmart-icon.svg?v=2", type: "image/svg+xml" },
